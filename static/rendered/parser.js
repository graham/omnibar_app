...
var test_strings = ["@graham $key=value", "%id=1 %type=Person $key=value blah blah blah $(asdf)", "%(id=1) @me $(name=Graham Abbott)", "%id=1 Lunch with todd $cost=14.99 $star #food", "%id=2 Lunch with todd cost=(cost) $cost=14.99 $star #food", "=[x(123)] @graham @code", "$project=what testing", "we should do x + y", "%data=({'one':1, 'two':2}) one two three"];

var search_strings = ["/food \\free :todd", "/asdf /work ;person", ":(person) /#asdf \\#work matcher", "/(#searching tag)", "#tag", ";task $due>=tomorrow", "$project==testing"];
